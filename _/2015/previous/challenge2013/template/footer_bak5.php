		...
		<div id="footer">
			...
			<div id="btmSponsorBK">
					...
					<ul class="platinum">
						...
						<!-- <li><a href="http://citydata.jp/" target="_blank"><img src="common/img/sponsores2012/citydata.png" alt="LinkData
独立行政法人　理化学研究所" width="180" height="180"></a></li> -->
					...
					<ul class="gold">
						...
						<li><a href="http://statdb.nstac.go.jp/" target="_blank"><img src="common/img/sponsores/NSTAC.png" alt="独立行政法人統計センター" /></a></li>
					...
					<ul class="gold">
						...
						<li><a href="http://www.microsoft.com/japan" target="_blank"><img src="common/img/sponsores/microsoft180.png" alt="日本マイクロソフト株式会社"></a></li>
						...
						<!--<li><a href="http://linkdata.org/" target="_blank"><img src="common/img/sponsores2012/linkdata140.png" alt="LinkData 独立行政法人　理化学研究所"></a></li> -->
					</ul>			
					...
					<ul class="supporter">
						<li><a href="http://www.osmf.jp/" target="_blank">オープンストリートマップ・ファウンデーション・ジャパン</a></li>
						...
						<!--<li><a href="http://www.ai-gakkai.or.jp/jsai/" target="_blank">社団法人　人工知能学会</a></li>-->
						<!--<li><a href="http://sigswo.org/" target="_blank">社団法人　人工知能学会　セマンティックウェブとオントロジー研究会</a></li>-->
						<!--<li><a href="http://s-web.sfc.keio.ac.jp/" target="_blank">セマンティックWeb委員会</a></li>-->
						<!--<li><a href="http://linkedopendata.jp/" target="_blank">特定非営利活動法人　リンクト・オープン・データ・イニシアティブ</a></li>-->
						<!--<li><a href="http://linkeddata.jp/" target="_blank">LinkedData勉強会</a></li>-->
					</ul>
