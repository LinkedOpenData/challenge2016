...
<h2 class="archive">カテゴリー： &#8216;<?php single_cat_title(); ?>&#8217;</h2>
<?php /* If this is a tag */ } elseif (is_tag()) { ?>
<h2 class="archive">タグ： &#8216;<?php single_tag_title(); ?>&#8217;</h2>
<?php /* If this is a daily archive */ } elseif (is_day()) { ?>
<h2 class="archive"><?php the_time('F jS, Y'); ?></h2>
<?php /* If this is a monthly archive */ } elseif (is_month()) { ?>
<h2 class="archive"><?php the_time('F, Y'); ?></h2>
<?php /* If this is a yearly archive */ } elseif (is_year()) { ?>
<h2 class="archive"><?php the_time('Y'); ?></h2>
