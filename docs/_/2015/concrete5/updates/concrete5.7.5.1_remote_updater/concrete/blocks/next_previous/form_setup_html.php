  ...
  <fieldset>
    <div class="form-group">
      ...
      <select name="orderBy" class="form-control">
          ...
          <option value="display_desc" <?php echo ($controller->orderBy=='display_desc') ? 'selected="selected"' : '' ?>><?php echo t('Reverse Sitemap')?></option>
          <option value="chrono_asc" <?php echo ($controller->orderBy=='chrono_asc') ? 'selected="selected"' : '' ?>><?php echo t('Reverse Chronological')?></option>
      </select>
    </div>
