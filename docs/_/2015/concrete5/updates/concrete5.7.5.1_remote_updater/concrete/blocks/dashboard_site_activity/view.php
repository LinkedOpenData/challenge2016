...
<p><?php echo t('Total form submissions: <strong>%s</strong> (<strong>%s</strong> today). <a href="%s">View Form Results</a>.', $totalFormSubmissions, $totalFormSubmissionsToday, $view->url('/dashboard/reports/forms'))?></p>