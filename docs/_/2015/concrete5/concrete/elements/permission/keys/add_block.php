...
<div class="form-group">
	...
	<div class="inputs-list" <?php if ($assignment->getBlockTypesAllowedPermission() != 'C') { ?>style="display: none"<?php } ?>>
		<?php foreach($blockTypes as $bt) { ?>
			<div class="checkbox"><label><input type="checkbox" name="btIDInclude[<?php echo $entity->getAccessEntityID()?>][]" value="<?php echo $bt->getBlockTypeID()?>" <?php if (in_array($bt->getBlockTypeID(), $assignment->getBlockTypesAllowedArray())) { ?> checked="checked" <?php } ?> /> <?php echo t($bt->getBlockTypeName())?></label></div>
		<?php } ?>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="inputs-list" <?php if ($assignment->getBlockTypesAllowedPermission() != 'C') { ?>style="display: none"<?php } ?>>
		<?php foreach($blockTypes as $bt) { ?>
        <div class="checkbox"><label><input type="checkbox" name="btIDExclude[<?php echo $entity->getAccessEntityID()?>][]" value="<?php echo $bt->getBlockTypeID()?>" <?php if (in_array($bt->getBlockTypeID(), $assignment->getBlockTypesAllowedArray())) { ?> checked="checked" <?php } ?> /> <span><?php echo t($bt->getBlockTypeName())?></span></label></div>
		<?php } ?>
	</div>
</div>
