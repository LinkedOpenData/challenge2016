<?php
	...
	if($_POST){
		...
		if(isset($_POST['id'])){
			$db->executeUpdate(
				"update dataset_2013 set name = '".$_POST['name']."' , affiliation = '".$_POST['affiliation']."' , affiliation_anonymous = ".$_POST['affiliation_anonymous']." , is_student = ".$_POST['is_student'].
				...
				"' , copyright = '".$_POST['right']."' , timestamp = '".date('c')."' , creator = '".$_POST['creator']."' ".
				"where id = ".$_POST['id'] );
			$db->executeUpdate( // input history
				"insert into dataset_input_2013 (master_id, name, affiliation, affiliation_anonymous, email, email_anonymous, dataset_name, url, abstract, request, related_dataset_ids, related_idea_ids, related_visualization_ids, copyright, timestamp, creator) ".
				"values (".$_POST['id'].", '".$_POST['name']."', '".$_POST['affiliation']."', ".$_POST['affiliation_anonymous'].", '".$_POST['email']."', ".$_POST['email_anonymous'].", '".$_POST['dataset-name']."', '".$_POST['dataset-url']."', '".$_POST['dataset-abstract']."', '".
					...
					"', '".$_POST['right']."', '".date('c')."', '".$_POST['creator']."')");
			// redirect
