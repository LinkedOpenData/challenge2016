...
echo "ID: ".$_POST['id']."password :".$_POST['password']." hashed pass: ".$_POST['password'],"<br />";
	...
	<table class="application-form" id="input-form">
		...
		<tr>
			...
			<td>
				...
				<div class="limit-description">vから始まるエントリー番号を入力．,2012年度の作品の場合は頭に2012-を入れる．複数ある場合は半角スペースで区切って下さい．(例: v003 v015)</div>
			</td>
		</tr>
		<tr>
