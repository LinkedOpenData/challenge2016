...
// echo "\$_POST[ $key  ] = " . $val ." -> " . $_POST[$key] . "<br />";
		...
		// 更新時
			$db->executeUpdate(
				"update idea_2014 set name = '".$_POST['name'].
			...
			$db->executeUpdate( // insert history
				"insert into idea_input_2014 (master_id, name, affiliation, affiliation_anonymous, is_student, email, email_anonymous, set_mailinglist, idea_name, abstract, description, related_dataset_ids, related_idea_ids, related_application_ids, related_visualization_ids, related_basetechnology_ids, type, url, timestamp) ".
				...
				$_POST['related-dataset']."', '".$_POST['related-idea']."', '".$_POST['related-application']."', '".$_POST['related-visualization']."', '".$_POST['related-basetechnology']."', '', '', NULL )");
			...
			if ( $_POST['changed_icon'] == 'true' ) {
					// アイコンファイルの移動
				rename(dirname(__FILE__).'/dat/tmp/'.$_POST['tmpiconname'], dirname(__FILE__). '/dat/icon/'.$ideaId.'_'.$_POST['tmpiconname']);
				// データベースにアイコンファイル名を登録
				$db->executeUpdate( // regist icon_filename
					"update idea_2014 set icon_filename = '". "./dat/icon/".$ideaId."_".$_POST['tmpiconname'].
					"' where id = ".$_POST['id'] );
			}
		...
		// 新規に登録
			...
			$result = $db->executeQuery("select * from idea_2014 where name = '".$_POST['name']."' and affiliation = '".$_POST['affiliation']."' and affiliation_anonymous = ".$_POST['affiliation_anonymous']." and email = '".$_POST['email']."' and email_anonymous = ".$_POST['email_anonymous']." and idea_name = '".$_POST['idea-name']."' and abstract = '".$_POST['idea-abstract'].
			...
			if(empty($result)){
				...
				$db->executeUpdate( 
					"insert into idea_2014 (name, affiliation, affiliation_anonymous, is_student, email, email_anonymous, set_mailinglist, idea_name, abstract, description, related_dataset_ids, related_idea_ids, related_application_ids, related_visualization_ids, related_basetechnology_ids, type, url, hashed_password, timestamp) ".
					"values ('".$_POST['name']."', '".$_POST['affiliation']."', ".$_POST['affiliation_anonymous'].", ".$_POST['is_student'].
						...
						"', '".$_POST['idea-select']."', '".$_POST['idea-url']."', '".$hash."', NULL )" );
				$insertId = $db->getLastInsertId();
				
				$db->executeUpdate( // insert history
					"insert into idea_input_2014 (master_id, name, affiliation, affiliation_anonymous, email, email_anonymous, idea_name, abstract, related_dataset_ids, related_idea_ids, related_application_ids, related_visualization_ids, related_basetechnology_ids, type, url, timestamp) ".
					"values (".$insertId.", '".$_POST['name']."', '".$_POST['affiliation']."', ".$_POST['affiliation_anonymous'].", ".$_POST['is_student'].
						", '".$_POST['email']."', ".$_POST['email_anonymous'].", ".$_POST['set_mailinglist'].
						", '".$_POST['idea-name']."', '".$_POST['idea-abstract']."', '".$_POST['idea-description'].
						"', '".$_POST['related-dataset']."', '".$_POST['related-idea']."', '".$_POST['related-application']."', '".$_POST['related-visualization']."', '".$_POST['related-basetechnology'].
						"', '".$_POST['idea-select']."', '".$_POST['idea-url']."', NULL )");
