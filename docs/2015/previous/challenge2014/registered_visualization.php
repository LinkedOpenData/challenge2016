...
// echo "\$_POST[ $key  ] = " . $val ." -> " . $_POST[$key] . "<br />";
		...
		// 更新時
			$db->executeUpdate(
				"update visualization_2014 set name = '".$_POST['name'].
			...
			$db->executeUpdate( // insert history
				...
				"values (".$_POST['id'].", '".$_POST['name']."', '".$_POST['affiliation']."', ".$_POST['affiliation_anonymous'].", ".$_POST['is_student'].
					...
					"', '".$_POST['visualization-select']."', '".$_POST['visualization-url']."', NULL , '".$_POST['right']."', '".$_POST['license']."')");
			...
			if ( $_POST['changed_icon'] == 'true' ) {
				// アイコンファイルの移動
				rename(dirname(__FILE__).'/dat/tmp/'.$_POST['tmpiconname'], dirname(__FILE__). '/dat/icon/'.$visualizationId.'_'.$_POST['tmpiconname']);
				// データベースにアイコンファイル名を登録
				$db->executeUpdate( // regist icon_filename
					"update visualization_2014 set icon_filename = '". "./dat/icon/".$visualizationId."_".$_POST['tmpiconname'].
					"' where id = ".$_POST['id'] );
			}
