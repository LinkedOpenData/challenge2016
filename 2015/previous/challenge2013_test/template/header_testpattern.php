...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<meta property="og:image" content="http://lod.sfc.keio.ac.jp/challenge2013/common/img/mainvisual2.png"/>
		<meta property="og:url" content="http://lod.sfc.keio.ac.jp/challenge2013/"/>
			...
			<div id="mainBK">
				...
				<div id="mainMenu">
					<ul id="nav">
						...
						<li id="hm002"><a href="javascript:void(0);" title="応募">応募</a>
						<!-- <li id="hm002"><a href="outline.html" title="応募について">応募について</a>-->
						<ul>
							<li><a href="outline.html">応募について</a></li>
							<li><a href="entry_terms.html">応募規定</a></li>
							<li><a href="">アイデア部門応募</a></li>
							<li><a href="">アプリケーショ部門応募</a></li>
							<li><a href="">データセット部門応募</a></li>
							<li><a href="">ビジュアライゼーション部門応募</a></li>
							<li><a href="">基盤技術部門応募</a></li>
						</ul></li>
						<li id="hm003"><a href="javascript:void(0);" title="エントリー">エントリー</a>
						<ul>
							<!-- <li>10月1日より応募開始です</li>-->
							...
							<li><a href="basic.html">基盤技術部門</a></li>
						</ul></li>
						<li id="hm004"><a href="javascript:void(0);" title="スポンサー">スポンサー</a>
						<ul>
							<li><a href="recommendation.html">LODチャレンジJapan2013への期待</a></li>
						...
						<li id="hm007"><a href="../blog/" title="公式ブログ">公式ブログ</a></li>
					</ul>
				</div><!--// mainMenu //-->
EOT;
